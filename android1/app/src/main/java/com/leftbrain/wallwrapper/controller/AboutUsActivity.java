...
public class AboutUsActivity extends WallWrapperBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textView.setText(Html.fromHtml("<font color=\"#666666\">高清壁纸管家有部分资源来源于互联网，图片版权归原作者所有，若有侵权问题敬请告知，我们会立即处理。本站图片资源如果没有特殊声明，</font><font color=\"#333333\">一律禁止任何形式的转载和盗用。</font>")); 
